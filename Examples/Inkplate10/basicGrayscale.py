# FILE: Inkplate10-basicGrayscale.py
# AUTHOR: Soldered
...
inkplate.writeFillRect(0, 0, 25, 825, 3)
inkplate.writeFillRect(25, 0, 25, 825, 2)
inkplate.writeFillRect(50, 0, 25, 825, 1)
inkplate.writeFillRect(75, 0, 25, 825, 0)

# Show on the display
inkplate.display()

# Let's draw the Soldered logo and show it on the display
inkplate.drawBitmap(248, 391, soldered_logo, 211, 44)
inkplate.display()
