"""Draw basic black and white shapes and a Soldered logo bitmap."""
...
# Hardware revision (classic v1 vs V2) is auto-detected. Pass variant="inkplate10v1" or
# variant="inkplate10v2" to override: Inkplate(Inkplate.INKPLATE_1BIT, variant="inkplate10v1")
...
for r in range(4):
    ...
    if inkplate.rotation % 2 == 0:
        inkplate.fill_triangle(500, 101, 400, 150, 400, 100, inkplate.BLACK)

    # Show on the display!
    # Use inkplate.partial_update instead of inkplate.display() to draw only updated pixels
    # This makes for a faster update
    # IMPORTANT: the display should be fully updated every ~10 partialUpdates
    # with inkplate.display()
...
inkplate.draw_bitmap(494, 391, soldered_logo, 211, 44)
