"""Draw different shades of gray in grayscale mode and display a Soldered logo bitmap."""
...
# variant="inkplate10v2" to override: Inkplate(Inkplate.INKPLATE_2BIT, variant="inkplate10v1")
...
# Draw a ramp of all 8 real gray levels (0=black .. 7=white).
