"""Draw a ramp of all 8 real gray levels and display a Soldered logo bitmap."""
...
# leaving the lower half clear for the logo (panel is 1024x758, same as Inkplate6FLICK).
for level in range(8):
    inkplate.write_fill_rect(level * 128, 0, 128, 300, level)

# Show on the display
inkplate.display()

# Let's draw the Soldered logo below the gray ramp and show it on the display
inkplate.draw_bitmap(406, 500, soldered_logo, 211, 44)
inkplate.display()
