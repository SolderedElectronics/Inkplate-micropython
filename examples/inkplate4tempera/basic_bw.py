...
for r in range(4):
    ...
    display.draw_rect(50, 50, 75, 75, display.BLACK)
    display.draw_circle(200, 200, 30, display.BLACK)
    display.fill_circle(300, 300, 30, display.BLACK)
    display.draw_fast_hline(20, 100, 50, display.BLACK)
    display.draw_fast_vline(100, 20, 50, display.BLACK)
    display.draw_line(100, 100, 400, 400, display.BLACK)
    display.draw_round_rect(100, 10, 100, 100, 10, display.BLACK)
    display.fill_round_rect(10, 100, 100, 100, 10, display.BLACK)
    ...
    if display.rotation % 2 == 0:
        display.fill_triangle(500, 101, 400, 150, 400, 100, display.BLACK)

    # Show on the display!
    # Use display.partial_update instead of display.display() to draw only updated pixels
...
display.draw_bitmap(194, 278, soldered_logo, 211, 44)  # centered on 600x600 panel
# Show on the display
display.display()
