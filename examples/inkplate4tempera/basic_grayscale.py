...
if __name__ == "__main__":
    ...
    # Drawing or printing text will have no effect on the display itself
    # before you call this function
    display.display()

    # Draw a ramp of all 8 real gray levels (0=black .. 7=white) across the top of the
    # panel, leaving the lower half clear for the logo (panel is 600x600).
    for level in range(8):
        display.write_fill_rect(level * 75, 0, 75, 300, level)

    # Let's draw the Soldered logo and show it on the display
    display.draw_bitmap(194, 428, soldered_logo, 211, 44)  # centered on 600x600 panel
