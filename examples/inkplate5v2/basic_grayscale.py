# FILE: Inkplate5v2-basic_grayscale.py
# AUTHOR: Soldered
...
# 0 being the darkest, 3 being the lightest
display.write_fill_rect(0, 0, 50, 720, 3)
display.write_fill_rect(50, 0, 50, 720, 2)
display.write_fill_rect(100, 0, 50, 720, 1)
display.write_fill_rect(150, 0, 50, 720, 0)
...
display.draw_bitmap(374, 348, soldered_logo, 211, 44)
